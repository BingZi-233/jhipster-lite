...
import static tech.jhipster.lite.shared.slug.domain.JHLiteFeatureSlug.OAUTH_PROVIDER_SPRINGDOC;
import static tech.jhipster.lite.shared.slug.domain.JHLiteFeatureSlug.SPRINGDOC;
import static tech.jhipster.lite.shared.slug.domain.JHLiteModuleSlug.SPRINGDOC_OAUTH_2_AUTH_0;
...
class SpringDocAuth0ModuleConfiguration {
  ...
  JHipsterModuleResource springDocAuth0Module(SpringDocAuth0ApplicationService springdocAuth0) {
    return JHipsterModuleResource.builder()
      ...
      .apiDoc("Spring Boot - API Documentation", "为springdoc添加Auth0身份验证")
      .organization(
